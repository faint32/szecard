...
import com.engc.szeduecard.adapter.ChooseDayOrTimeAdapter;
...
import com.engc.times.calendar.CalendarPickerView;
import com.engc.times.calendar.CalendarPickerView.SelectionMode;
 ...
 * 
 */
public class CalendarPick extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		imgBack = (Button) findViewById(R.id.btn_calendar_back);
		...
		calendar.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
					long arg3) {
				Intent intent = new Intent(CalendarPick.this, AskForLeave.class);

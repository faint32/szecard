...
import com.engc.szeduecard.adapter.ListViewHoildayRecordAdapter.ListItemView;
...
/**
 * 家庭作业适配
 * @ClassName: ListViewHomeWorkAdapter 
 * @Description: TODO
 * @author wutao
 * @date 2013-12-13 下午2:54:47 
 *
 */
public class ListViewHomeWorkAdapter extends BaseAdapter {
	 ...
	 * @param resource
	 */
	public ListViewHomeWorkAdapter(Context context, List<HomeWork> data,
			int resource) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		HomeWork hm = listItems.get(position);

		listItemView.title.setText(hm.getName());

		listItemView.title.setTag(hm);// 设置隐藏参数(实体类)
		...
		listItemView.flag.setImageResource(R.drawable.app_icon_1);
